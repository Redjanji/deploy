...
public class TimezoneService {
    ...
    public List<Map<String, Object>> getTimezones(String keyword) {
        String kw = keyword != null ? keyword : "all";
        String cacheKey = "timezones:list:" + kw;
        return queryListWithCache(cacheKey, () -> timezoneMapper.selectTimezones(keyword));
    }

    public Map<String, Object> getTimezone(String timezoneId) {
        String cacheKey = "timezones:detail:" + timezoneId;
        return queryMapWithCache(cacheKey, () -> timezoneMapper.selectTimezoneById(timezoneId));
    }
    ...
    public void clearCache() {
        Set<String> keys = redisTemplate.execute((RedisCallback<Set<String>>) connection -> {
            ...
            try (Cursor<byte[]> cursor = connection.scan(
                    ScanOptions.scanOptions().match("timezones:*").count(100).build())) {
